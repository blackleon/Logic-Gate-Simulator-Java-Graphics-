...
//------###AND 3 CLASS I COMPONENTTEN MİRAS###
public class AND3 extends Component{

    //AND3 Constructor
    public AND3(int x, int y, boolean tbItem) {
        super(x, y, tbItem);
        initImage();
    ...
    {
        return "simulator.AND3";
    }
    
    //Resmi güncelleme
    public void initImage()
    {
        loadImage("images\\and3.png");
        getImageDimensions();
    }
}